...
// Each  roubackboneter also has a local 802.11 network and is connected
...
main (int argc, char *argv[])
{
  ...
  Ptr<OutputStreamWrapper> stream = ascii.CreateFileStream ("./scratch/mixed-demo/mixed-wireless.tr");
  ...
  AnimationInterface anim ("./scratch/mixed-demo/mixed-wireless.xml");
